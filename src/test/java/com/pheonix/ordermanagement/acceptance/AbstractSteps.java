...
import com.pheonix.ordermanagement.SpringUnitAcceptanceOrderManagementApplication;

@WebAppConfiguration
@ContextConfiguration(classes = SpringUnitAcceptanceOrderManagementApplication.class)
